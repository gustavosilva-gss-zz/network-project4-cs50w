...
def following(request):
    ...
    posts = [] #initialize list

    #first get all followed users by the one logged
    for post in all_posts:
        #only add to the list the posts made by users followed by the logged user
...
def edit(request):
    if request.method != "PUT":
        #has to be PUT method to create a post in the network
